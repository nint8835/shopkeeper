...
export type ShopkeeperFetcherOptions<TBody, THeaders, TQueryParams, TPathParams> = {
    url: string;
    method: string;
    body?: TBody;
    headers?: THeaders;
...
export async function shopkeeperFetch<
    TData,
    TError,
...
>({
    ...
    queryParams,
    signal,
}: ShopkeeperFetcherOptions<TBody, THeaders, TQueryParams, TPathParams>): Promise<TData> {
