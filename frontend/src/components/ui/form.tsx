...
// Custom component based on FormMessage which will display the root error message for a form.
const RootFormMessage = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
    ({ className, children, ...props }, ref) => {
        const {
            formState: { errors },
        } = useFormContext();
